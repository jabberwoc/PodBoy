...
namespace PodBoy.Virtualization
{
    ...
    public class VirtualizingCollection<T> : IList<T>, IList, IEnableLogger
    {
        /// <summary>
        ...
        public VirtualizingCollection(IItemsProvider<T> itemsProvider, int pageSize = 100, int pageTimeout = 10000)
        {
        ...
        {
            get { return pages.Values.SelectMany(_ => _).ToList(); }
        }
        ...
        {
            List<int> keys = new List<int>(pageTouchTimes.Keys);
