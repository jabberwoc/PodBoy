...
{
    /// <summary>
    /// Interaction logic for BusyWheel.xaml
    /// </summary>
    public partial class BusyWheel
    {
        public static readonly DependencyProperty MinimumProperty = DependencyProperty.Register("Minimum", typeof(int),
            typeof(BusyWheel), new UIPropertyMetadata(1));
        ...
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register("Value", typeof(int),
            typeof(BusyWheel), new UIPropertyMetadata(100));
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BusyWheel"/> class.
        /// </summary>
        public BusyWheel()
        {
            InitializeComponent();
